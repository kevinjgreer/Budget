function Convert-CSVAdditionFinancial {
    ...
    process {
        If (-not $PSBoundParameters.ContainsKey('Path')) {
            ...
            $Path = (get-childitem -Path "$env:USERPROFILE\Downloads" -Filter "AdditionFinancialTransactions*" | Sort-Object -Property LastWriteTime | Select-Object -Last 1).FullName
        }
